...
const _TtsSession = class _TtsSession {
  ...
  async predict(text) {
    ...
    const speakerId = _TtsSession.speakerId ?? 0;
    const sampleRate = __privateGet(this, _modelConfig).audio.sample_rate;
    const noiseScale = _TtsSession.noiseScale ?? __privateGet(this, _modelConfig).inference.noise_scale;
    const lengthScale = _TtsSession.lengthScale ?? __privateGet(this, _modelConfig).inference.length_scale;
    const noiseW = _TtsSession.noiseW ?? __privateGet(this, _modelConfig).inference.noise_w;
...
__publicField(_TtsSession, "speakerId", null);
__publicField(_TtsSession, "noiseScale", null);
__publicField(_TtsSession, "noiseW", null);
__publicField(_TtsSession, "lengthScale", null);
